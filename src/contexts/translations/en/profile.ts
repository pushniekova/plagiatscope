...
export default {
  ...
  settings: {
    ...
    marketingEmailsDesc: 'Receive emails about our news and promotions',
    security: 'Security',
  ...
  services: {
    ...
    serviceTitle1: 'Text Check',
    serviceDesc1: 'Check text for plagiarism',
    serviceTitle2: 'Image Check',
    serviceDesc2: 'Check images for manipulations',
    serviceTitle3: 'API Access',
    serviceDesc3: 'Access to our API for integration',
    status: {
      active: 'Active',
      inactive: 'Inactive'
    },
